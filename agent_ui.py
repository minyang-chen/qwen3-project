...
class AgentWebUI:
    ...
    def __init__(
        ...
        self.input_placeholder = chatbot_config.get(
            "input.placeholder", "enter your query here then press submit"
        )
            ...
            with ms.Application():
                with gr.Row(elem_classes="container"):
                    ...
                    with gr.Column(scale=1):
                        ...
                        if self.think_mode:
                            agent_think_mode_radio = (
                                self._create_agent_think_mode_radio(
                                    think_mode="thinking"
                                )
                            )
                        else:
    ...
    def change_think_mode(self, agent_think_mode):
        from qwen_agent.agents import Assistant

        return self._create_agent_think_mode_radio(think_mode=agent_think_mode)
    ...
    def _create_agent_think_mode_radio(
        self, agent_index=0, think_mode: str = "thinking"
    ):
        from qwen_agent.gui.gradio_dep import gr
        ...
        radio = gr.Radio(
            ...
            value=think_mode,
            label="Active generation method",
            interactive=False,
        )
        return radio
