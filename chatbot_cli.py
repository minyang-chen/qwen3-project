...
"""A simple command-line interactive chatbot."""
...
DEFAULT_CKPT_PATH = "Qwen/Qwen3-1.7B"

_WELCOME_MSG = """\
Welcome to use Qwen3 model, type text to start chat, type :h to show command help.

Note: This chatbot is governed by the original license of Qwen3.
...
def main():
    parser = argparse.ArgumentParser(
        description="Qwen3 command-line interactive chat demo."
    )
    parser.add_argument(
        "-c",
        "--checkpoint-path",
    ...
    parser.add_argument("-s", "--seed", type=int, default=12321, help="Random seed")
    parser.add_argument(
        "--cpu-only", action="store_true", help="Run chatbot with CPU only"
    )
